const valid = (username, password, firstname, lastname) => {
    const err = {}

    if(!firstname) {
        err.firstname = "Please add your first name."
    }else if(firstname.length > 12){
        err.firstname = "First name is up to 12 characters long."
    }

    if(!lastname) {
        err.lastname = "Please add your last name."
    }else if(lastname.length > 12){
        err.lastname = "Last name is up to 12 characters long."
    }
